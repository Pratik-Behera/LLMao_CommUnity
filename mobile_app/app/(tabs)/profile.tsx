import { View, Text, ScrollView, TouchableOpacity, SafeAreaView, ActivityIndicator, TextInput, Modal } from 'react-native';
...
export default function ProfileScreen() {
  ...
  const handleAiEvaluation = async () => {
    ...
    // Process sensors
    const sensors = {
      psi_current: parseInt(psi),
      psi_trend_3h: [140, 160, parseInt(psi)],
      rainfall: parseInt(rainfall),
      temperature: 31,
      month: 'September'
    };

    const decision = await mockTriggerEngine.evaluateTrigger(sensors);
    ...
    <SafeAreaView className="flex-1 bg-background-light dark:bg-background-dark">
      <View className="flex-1">
        ...
        <ScrollView className="flex-1" contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          {isAdmin ? (
            <View className="px-4">
              ...
              <View className="bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-100 dark:border-slate-800 shadow-sm">
                ...
                >
                  ...
                  <Text className="text-white font-bold">Evaluate via GPT-4o</Text>
                </TouchableOpacity>
              ...
              <TouchableOpacity className="mt-6 flex-row items-center justify-between p-5 bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800">
                <View className="flex-row items-center gap-3">
            ...
            <View className="px-4">
               ...
               <View className="bg-white dark:bg-slate-900 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 gap-4">
                  ...
                  <View className="h-[1] bg-slate-100 dark:bg-slate-800" />
          ...
          <TouchableOpacity className="mx-4 mt-8 bg-slate-100 dark:bg-slate-800 py-4 rounded-xl items-center flex-row justify-center gap-2">
